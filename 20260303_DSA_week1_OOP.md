...
*Updated 2026-03-02 14:35 GMT+8*  
...
>
> ​	哈希，双指针，滑动窗口，子串，普通数组，回溯，二分查找，贪心算法，动态规划，技巧，图论
>
> 
>
> **小北智学/AI答疑** zx.pku.edu.cn
>
...
> 服务对象：面向全校师生开放使用
>
> <img src="https://raw.githubusercontent.com/GMyhf/img/main/img/image-20260302160550363.png" alt="image-20260302160550363" style="zoom: 50%;" />
>
> 
...
**Q:** Python 操作符优先级，与 C++ 操作符优先级的不同？比如：位运算、移位运算，与==关系。
...
>
> ⚠️：上面的 `class Stack` 是对“栈”这一 ADT 的一个具体实现。你也可以用链表重新实现一次 `Stack` 类，只要行为符合 ADT 规范，就是合法的。
>
> ---
>
> 4. **为什么说 ADT 更“高级”？**
